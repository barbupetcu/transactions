...
/*
* Din raport inteleg ca o persoana poate avea un singur cont
* In cazul in care o persoana poate avea mai multe conturi:
*
    * - se creeaza o alta entitate Account in care se vor muta: IBAN, AMOUNT
    * - entitatea Account va contine o coloana de legatura cu Person (@ManyToOne)
    * - in entitatea Transaction coloanele payer si payee nu va mai contine Person, ci Account
 */
